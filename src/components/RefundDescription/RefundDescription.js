                    ...
                    <Row>
                        <Col lg={12} md={12} sm={12}>
                            ...
                            <p className='serviceDescription'>
                                <ul>
                                    <li>
                                        Processing is lawful, fair, transparent. Our Processing activities have lawful grounds. We always
                                ...
                                <p>
                                    ...
                                    visitor’s IP address and browser user agent string to help spam detection.<br></br>
                                    ...
                                    public in the context of your comment.<br></br><br></br>
                                    ...
                                    on the website.<br></br><br></br>

                                    <b>Contact forms</b><br></br>
                                    We may use contact form submission information to get in touch with you. We do not use the information
                                    submitted through contact form for marketing purposes<br></br><br></br>
                                    ...
                                    contentfrom other websites behaves in the exact same way as if the visitor has visited the other 
                                    website. <br></br><br></br>
